...
if res:
    ...
    output_folder = "test_results/bloom"
    os.makedirs(output_folder, exist_ok=True)

    # overall scores
    output_path = os.path.join(
        output_folder, f"level_ragas_scores_baseline_{timestamp}.txt"
    )
    ...
    qa_output_path = os.path.join(
        output_folder, f"qa_outputs_baseline_{timestamp}.json"
    )
